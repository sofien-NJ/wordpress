 ...
 */
function creativeily_blog_custom_header_setup() {
	...
	register_default_headers( array(
		'header-bg' => array(
			...
			'description'   => _x( 'Default', 'Default header image', 'creativeily-blog' )
			),	
		) );

}
add_action( 'after_setup_theme', 'creativeily_blog_custom_header_setup' );

if ( ! function_exists( 'creativeily_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see creativeily_blog_custom_header_setup().
	 */
